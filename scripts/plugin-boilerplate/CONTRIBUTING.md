...
[Vienna project](https://github.com/tryvienna/desktop) — start there for the
detailed guide.
...
This project follows the Vienna project's
[Code of Conduct](https://github.com/tryvienna/desktop/blob/main/CODE_OF_CONDUCT.md).
Report concerns to `conduct@tryvienna.dev`.

## Security

Report vulnerabilities privately to `security@tryvienna.dev`. See the main
Vienna [SECURITY.md](https://github.com/tryvienna/desktop/blob/main/SECURITY.md)
